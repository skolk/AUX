...
Relay::Relay valve1(PIN_VALVE1_OPEN, PIN_VALVE1_CLOSE);
Relay::Relay valve2(PIN_VALVE2_OPEN, PIN_VALVE2_CLOSE);
Relay::Relay valve3(PIN_VALVE3_OPEN, PIN_VALVE3_CLOSE);
